<div id="cart" class="btn-group  <?php echo $mini_header_cart_class; ?>">
          ...
          <td class="name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
			...
			<td class="qt">
				<div class="number">
					...
					<input type="text" name="quantity[<?php echo $product['cart_id']; ?>]" value="<?php echo $product['quantity']; ?>" onchange="update_cart_manual(this, '<?php echo $product['cart_id']; ?>', '<?php echo $product['minimum']; ?>', '<?php echo $product['quantity_pr']; ?>');" onkeyup="update_cart_manual(this, '<?php echo $product['cart_id']; ?>', '<?php echo $product['minimum']; ?>', '<?php echo $product['quantity_pr']; ?>');" size="1" class="plus-minus cartid_<?php echo $product['cart_id']; ?>" /> 
				</div>
			</td>
